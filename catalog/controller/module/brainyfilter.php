...
class ControllerModuleBrainyFilter extends Controller {
	public function index($setting) {
		...
		$this->data['base'] = preg_replace('/https?:\/\/[^\/]+/', '', $this->config->get('config_url'));
        ...
        $rawFilterData = json_decode($this->request->get['bfilterraw'], true);
		$this->data['selected_attr'] = isset($rawFilterData['attr']) 
				? $rawFilterData['attr']
				: array();
		$this->data['selected_manufacturer'] = isset($rawFilterData['brand']) 
				? $rawFilterData['brand']
				: array();
		$this->data['selected_statuses'] = isset($rawFilterData['stock'])
				? $rawFilterData['stock']
				: array();
		$this->data['selected_rating'] = isset($rawFilterData['rating'])
				? $rawFilterData['rating']
				: array();
		$this->data['selected_option'] = isset($rawFilterData['option'])
				? $rawFilterData['option']
				: array();
		...
		$this->data['lowerlimit']           = isset($rawFilterData['lower']) ? $rawFilterData['lower'] : $this->data['priceMin'];
		$this->data['upperlimit']           = isset($rawFilterData['higher']) ? $rawFilterData['higher'] : $this->data['priceMax'];
		$this->data['attr_groups']          = false; 
