...
<?php if( $SPAN[0] ): ?>
	<div class="col-lg-<?php echo $SPAN[0];?> col-md-<?php echo $SPAN[0];?>">
		<?php echo $column_left; ?>
	</div>
<?php endif; ?> 
<div class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12  main-column">
...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="col-lg-5 col-sm-6">
		 ...
		 <div class="heading_add"><span> <?php echo $jan ?></span></div>
...
<div class="addthis_sharing_toolbox"></div><!-- Go to www.addthis.com/dashboard to customize your tools --><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-53c2543d1dc0a472"></script>
          <!-- AddThis Button END --> 
        </div>
      ...
      <div class="description">
        ...
        <?php } ?>
		<?php if ($weight>0) { ?>
		<span>Вес</span> <?php echo round($weight, 2); ?><?php echo " грамм<br />"; ?>
		<?php } ?>
		<?php if ($isbn) { ?>
		<span>Кол-во в упаковке:</span> <?php echo $isbn; ?>
		 <?php } ?><br />
        <?php if ($reward) { ?>
        <span><?php echo $text_reward; ?></span> <?php echo $reward; ?><br />
        <?php } ?>
        	<br />
		<?php if ($upc) { ?>		 		<a href='http://jinn.ru.xsph.ru/index.php?route=product/special'><span>Проверено WonderSeed:</span></a> <?php echo $upc; ?><br />				 <?php } ?>		 		 <?php if ($sku) { ?>		<span>Артикул:</span> <?php echo $sku; ?><br />		 <?php } ?></div>
...
<?php if( $SPAN[2] ): ?>
<div class="col-lg-<?php echo $SPAN[2];?> col-md-<?php echo $SPAN[2];?>">	
