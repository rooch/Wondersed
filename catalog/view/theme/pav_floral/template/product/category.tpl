...
<div id="content"><?php echo $content_top; ?>
 ...
 <div class="refine ">
  ...
  <div class="product-filter clearfix">
	...
	<!-- Сравнение <div class="product-compare"><a href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a></div> -->
...
<div class="product-list"> <div class="products-block">
    ...
    <div class="col-xs-<?php echo $mini;?> col-lg-<?php echo $span;?> col-md-<?php echo $span;?> col-sm-<?php echo $small;?>">
    	<div class="product-block">	
		  ...
		  <div class="description"><?php echo utf8_substr( strip_tags($product['description2']),0,160);?></div>
...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<span style="float: left;"><?php echo $text_display; ?></span><a class="list active"><span class="icon-th-list"></span><em><?php echo $text_list; ?></em></a><a class="grid"  onclick="display(\'grid\');"><span class="icon-th-large"></span><em><?php echo $text_grid; ?></em></a>');
		...
		$('.display').html('<span style="float: left;"><?php echo $text_display; ?></span><a class="list" onclick="display(\'list\');"><span class="icon-th-list"></span><em><?php echo $text_list; ?></em></a><a class="grid active"><span class="icon-th-large"></span><em><?php echo $text_grid; ?></em></a>');
