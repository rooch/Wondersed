			...
			<div class="column col-xs-12 col-sm-6 col-lg-2">
				<div class="box">
					...
					<ul class="list">
					  ...
					  <li><a href="<?php echo $information['href']; ?>"><i class="icon-long-arrow-right"></i><?php echo $information['title']; ?></a></li>
					  <?php } ?>
					</ul>
				</div>
			</div>
...
<?php  } ?>	
	...
	<?php } else { ?>
		<?php echo $themeConfig['copyright']; ?>. 
	<?php } ?>
	Design By <a href="mailto:jozo1@yandex.ru" title="Создание сайтов. Частное лицо.">Jozo</a></div>
