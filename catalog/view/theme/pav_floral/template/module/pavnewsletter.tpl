<div class="<?php echo $prefix; ?> box newsletter_block" id="newsletter_<?php echo $position.$module;?>">
	<div class="row">
		<div class="col-sm-6 title_block"><?php echo $this->language->get("entry_newsletter");?></div>
		<div class="col-sm-6 block_content">
				...
				<div class="wrap-input">
					...
					<!--<select name="action">
						...
						<button type="submit" name="submitNewsletter" class="button_mini pull-right" value="<?php echo $this->language->get("button_ok");?>" ><i class="icon-long-arrow-right"></i></button>
