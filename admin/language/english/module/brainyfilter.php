...
$_['bf_signature']						= "Не редактировать";

// Heading
$_['heading_title']       = 'Фильтр (основной)';
...
$_['text_attributes_display'] 		= 'Attributes Display';
...
$_['entry_select_all']    			= 'Select all attributes';
...
$_['entry_manufacturer']  			= 'Enable manufacturers'; 
$_['entry_hide_panel']  			= 'Fade out the filter panel during requests';
$_['entry_price_filter']  			= 'Enable price filter';
...
$_['entry_subcats_fix']				= '<b>Show products from subcategories in their parent categories.</b> This option enables showing products from child categories in the corresponding parent categories and invokes Brainy Filter for them. By default OpenCart requires adding each product into both a child and its parent category by hand.';
$_['entry_stock_status']			= 'Enable filter by stock status';
$_['entry_stock_status_id']			= '<b>In Stock Status</b><span class="help">Set the default out of stock status selected in product edit.</span>';
$_['entry_product_count']			= 'Enable product counts';
$_['entry_enable_attributes']		= 'Enable attributes';
$_['entry_block_title']             = 'Filter Block Title';
$_['entry_opencart_filters']        = 'Enable standard OpenCart filters';
$_['entry_rating']       		    = 'Enable rating';
$_['entry_option']       		    = 'Enable product options';
